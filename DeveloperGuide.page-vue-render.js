...
with(this){return _c('p',[_v("We have added an attribute "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Merit Score")]),_v(" to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" Class. The reason behind this is to have a measurement of a user's credibility, so that the library will not run out of books due to excessive borrow. "),_c('br'),_v(" "),_c('br'),_v("\nEvery user will have a default merit score of 0 upon adding to the Contact List. Donating and returning books will increase the user's merit score by 1, while borrowing books will decrease user's merit score by 1. "),_c('br'),_v(" "),_c('br'),_v("\nBefore borrowing, "),_c('strong',[_v("MyBookshelf")]),_v(" will check if the user has sufficient merit score. Successful borrow only happens when user's merit score exceeds the limit threshold. "),_c('br'),_v(" "),_c('br'),_v("\nPS: You can set the threshold by using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("limit")]),_v(" command. See more below.")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"library-and-librarylogic-feature"}},[_v("Library and LibraryLogic feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#library-and-librarylogic-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_c('strong',[_v("[Library & LibraryLogic (should be Library Storage) implementation to be added here, mention why not a part of storage, mention cannot change book list directly in app]")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Fri, 12 Apr 2024, 20:29:13 GMT+8]")])])])}
}];
